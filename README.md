...
◽  [Сайт специалиста на Tilda с ИИ-консультантом](https://github.com/annutte/prompten) – нейроассистент на сайте консультирует посетителей по услугам и подводит к заполнению формы заявки.  
◽  [Сайт на Tilda для врача-остеопата](https://github.com/annutte/osteo) – Сайт для врача-остеопата с блогом и лид-магнитом.  
◽  [ИИ-консультантом для сайта клиники](https://github.com/annutte/Medclinic) – ИИ-ассистент консультирует по услугам, стоимости и расписанию врачей, записывает на приём, рассылает уведомления и напоминания о приёме.  
◽  **Генератор SEO-описаний** – сокращает время оформления страниц товаров на 40%.  
◽  [Контент-студия для бренда](https://github.com/annutte/Casa_Lusso_Content_Studio/tree/main) с заданным tone-of-voice и мультиязычной адаптацией – генерирует статьи для сайта на 4 языках, адаптирует тексты для соцсетей.  
...
◽  [Ивент-бот для бизнес-завтрака](https://github.com/annutte/Biflex_Event_bot) – предоставляет информацию о мероприятии и брендах-участниках, рассылает напоминания и ссылки на полезные материалы.  
◽  [Тренажёр для подготовки школьников к ОГЭ по обществознанию](https://github.com/annutte/OGE_Society_bot) – бот в Telegram с краткой теорией, заданиями из банка ФИПИ и ИИ-репетитором.  
◽  [Бот-нутрициолог с ИИ](https://github.com/annutte/Nutri_bot/) – генерирует меню на неделю с учётом индивидуальных требований.  
