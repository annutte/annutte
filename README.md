...
Высшее образование в IT, более 18 лет в маркетинге, последний год – в сфере искусственного интеллекта и нейросетей.**  
...
## ⚙️ Скилсет  
 ...
 ◽ Контент-маркетинг с помощью LLM   
 ◽ SEO-копирайтинг  
 ◽ Вайб-кодинг  
...
◽  [Сайт специалиста на Tilda](https://github.com/annutte/prompten) – Сайт промпт-инженера с нейроассистентом.  
◽  [Сайт врача-остеопата на Tilda ](https://github.com/annutte/osteo) – Сайт для врача-остеопата с блогом и лид-магнитом.  
◽  [ИИ-консультант для сайта клиники](https://github.com/annutte/Medclinic) – Виджет с ИИ-ассистентом. Информация по услугам, стоимости и расписанию врачей, запись на приём, рассылка уведомлений и напоминаний о приёме.  
◽  [Генератор SEO-описаний](https://prompten.ru/new-website-promoting/tproduct/395941872212-generator-seo-opisanii) – Веб-интерфейс для генерации описаний товаров и метатегов.  
◽  [Контент-студия для бренда](https://github.com/annutte/Casa_Lusso_Content_Studio/tree/main) GPT агент с базой знаний. Генерирует статьи для сайта на 4 языках, адаптирует тексты для соцсетей.  
◽  [HR-ассистент в Telegram](https://github.com/annutte/HR-assistant-fleetservice) – Предоставляет информацию о вакансиях в компании, консультирует соискателей и помогает подобрать подходящую вакансию.  
◽  [Ивент-бот для бизнес-завтрака](https://github.com/annutte/Biflex_Event_bot) – Информационная поддержка мероприятия: контакты, бренды-участники, рассылка напоминаний и маркетинговых материалов.  
◽  [Тренажёр для подготовки школьников к ОГЭ по обществознанию](https://github.com/annutte/OGE_Society_bot) – Бот в Telegram выдаёт краткую теорию по темам и проверочные задания из банка ФИПИ. ИИ-репетитор проверяет ответы и подсказывает лайфхаки для запоминания материала.  
◽  [Бот-нутрициолог с ИИ](https://github.com/annutte/Nutri_bot/) – Генерирует меню на неделю с учётом калорийности и индивидуальных параметров.  
