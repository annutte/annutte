...
◽  [Сайт специалиста на Tilda с ИИ-консультантом](https://github.com/annutte/prompten) – Сайт промпт-инженера с нейроассистентом.  
◽  [Сайт на Tilda для врача-остеопата](https://github.com/annutte/osteo) – Сайт для врача-остеопата с блогом и лид-магнитом.  
◽  [ИИ-консультант для сайта клиники](https://github.com/annutte/Medclinic) – ИИ-ассистент консультирует по услугам, стоимости и расписанию врачей, записывает на приём, рассылает уведомления и напоминания о приёме.  
◽  **Генератор SEO-описаний** – Чат-бот для генерации описаний товаров и метатегов.  
